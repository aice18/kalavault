  ...
  const services = [
    {
      ...
      description: "High-end framing solutions tailored to the client's existing interior design and color palette. We work with master framers in Europe to ensure archival conservation limits absolute UV exposure while remaining visually weightless.",
      image: "https://images.unsplash.com/photo-1549490349-8643362247b5?auto=format&fit=crop&q=80&w=1200"
    },
    {
      number: "02",
      title: "Precision Installation",
      description: "Professional mounting and secure installation by expert handlers to ensure workplace safety and architectural alignment. We conduct rigorous stress tests and structural reviews for high-traffic environments.",
    ...
    },
    {
      ...
      description: "Seamless, secure transport of all pieces from our network directly to your office suite. We manage all climate-controlled shipping logistics, customs declarations, and on-site delivery globally.",
      image: "https://images.unsplash.com/photo-1620311488185-5eb762cb04b3?auto=format&fit=crop&q=80&w=1200"
    },
    {
      number: "04",
      title: "Concierge Protection Plan",
      description: "A dedicated coverage program to protect assets against unforeseen damage in the corporate environment, offering immediate conservation response and full liability protection.",
      image: "https://images.unsplash.com/photo-1562663474-6cbb3eaa4d14?auto=format&fit=crop&q=80&w=1200"
    },
    {
      number: "05",
      title: "Strategic Asset Rotation",
      description: "Quarterly or bi-annual collection refresh to maintain dynamic environments. We carefully map rotation schedules to align with seasonal changes, corporate milestones, or architectural updates.",
      image: "https://images.unsplash.com/photo-1563089145-599997674dc9?auto=format&fit=crop&q=80&w=1200"
    }
  ];
        ...
        <section className="px-8 md:px-16 max-w-[1600px] mx-auto mt-32 mb-16 relative">
          ...
          >
             ...
             <h2 className="font-display-lg text-4xl md:text-6xl text-white tracking-tight mb-12 relative z-10 max-w-3xl">
               Ready to transform your architectural space?
             </h2>
