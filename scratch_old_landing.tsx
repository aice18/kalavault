...
const TESTIMONIALS_DATA = [
  {
    id: 1,
    client: "ITC Group",
    quote: "ΓÇ£The curation process was exceptionally smooth, and the quarterly artwork rotations have completely transformed our corporate headquarters. It fosters an inspiring, sophisticated atmosphere for both our clients and employees.ΓÇ¥",
  ...
  },
  {
    id: 2,
    client: "JLL Americas",
    quote: "ΓÇ£Kalavault's white-glove service and dynamic leasing model are exactly what modern commercial spaces need. The architectural-scale installations have given our properties a distinct, premium identity that wows stakeholders.ΓÇ¥",
  ...
  },
  {
    ...
    quote: "ΓÇ£As a private collector, having access to such a diverse range of museum-grade pieces with the flexibility of a monthly subscription is a dream. The placement and framing are masterfully executed.ΓÇ¥",
  ...
  },
  {
    ...
    quote: "ΓÇ£The transition between different thematic seasons keeps our boutique gallery space alive, responsive, and engaging. The curation is tailored perfectly to our color scheme and lighting design.ΓÇ¥",
